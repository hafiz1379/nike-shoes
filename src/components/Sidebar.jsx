...
function Sidebar({ children, isOpen, onClickClose }) {
  return (
<div>
    <div className={`overflow-y-auto p-5 fixed right-0 z-50 top-0 w-full h-full md:w-[50%] lg:w-[35%] shadow-lg bg-white transform transition duration-300 ${isOpen ? "translate-x-0" : "translate-x-full"}`}>
